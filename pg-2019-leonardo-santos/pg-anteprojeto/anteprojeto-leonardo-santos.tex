...
\renewcommand{\imprimircapa}{%
	\begin{capa}%
		...
		\begin{minipage}{.5\textwidth}
			...
			\assinatura{\textbf{Aluno: Leonardo Nascimento dos Santos}}
			\assinatura{\textbf{Orientador: Prof. Dr. Vítor E. Silva Souza}}
		\end{minipage}
...
sistema SCAP utilizando os frameworks Grails e GWT}
...
\input{capitulos/ch1-introducao}
\input{capitulos/ch2-objetivos}
\input{capitulos/ch3-metodo}
\input{capitulos/ch4-cronograma}
