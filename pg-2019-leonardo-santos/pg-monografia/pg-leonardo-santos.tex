...
\begin{dedicatoria}
   ...
   \centering
   \noindent
   \textit{A Deus e aos meus pais que são tudo em minha vida.} \vspace*{\fill}
\end{dedicatoria}
...
No desenvolvimento das primeiras aplicações para \textit{Web}, a preocupação em seguir a metodologia proposta pela Engenharia de Software não era muito relevante, fazendo com que estas aplicações fossem criadas de maneira \textit{ad-hoc}. Com a evolução e o crescimento da Internet, a construção de \textit{softwares} voltados para esse tipo de plataforma foi se tornando cada vez mais complexa, sendo necessário a adoção de técnicas que favorecessem a criação e adaptação das aplicações. Para esse fim, foi criada a Engenharia \textit{Web} (\textit{Web Enginnering} ou \textit{WebE}).       
