...
\begin{table}[h]
	...
	\begin{tabular}{|p{3.5cm}|p{2cm}|p{1.9cm}|p{7cm}|}  \hline 
		...
		Segurança de Acesso & RNF01 & Sim & • Garantir que os dados estão acessíveis apenas para aqueles que estão autorizados a acessá-los, evitando acesso não autorizado ou modificação dos dados.\\ &&&• Autorizar usuários, usando as classes de usuários definidas no Projeto ODE. \\\hline
